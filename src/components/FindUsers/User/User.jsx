			...
			<div className={s.user__body}>
				<div className={s.user__photo}>
					...
					<div className={s.user__button__body}>
						{props.sub ? <button type="submit" onClick={() => props.unfollow(props.id)} className={`${s.user__button} button`}>Unfollow</button> : <button type="submit" onClick={() => props.follow(props.id)} className={`${s.user__button} button`}>Follow</button>}
					</div>
				</div>
